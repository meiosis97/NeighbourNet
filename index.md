...
The data and the reproducible R scripts used to generate the figures in
...
run‑time.  
Tweak gene lists, increase `responses`, or switch visualisation
parameters exactly as in the full vignette.
